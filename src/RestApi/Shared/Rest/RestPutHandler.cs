...
{
    public class RestPutHandler<TEntity, TGetModel> : RestApiValidatedHandler<RestPutRequest<TEntity, TGetModel>, TGetModel>
        where TEntity : RestApiEntity
        where TGetModel : IGetModel
    {
        public RestPutHandler(RestApiDbContext opinionatedDbContext, IMapper mapper, IEnumerable<IValidator<RestPutRequest<TEntity, TGetModel>>> validators)
